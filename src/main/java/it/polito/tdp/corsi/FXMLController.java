...
public class FXMLController {
    ...
    void stampaDivisione(ActionEvent event) {
        ...
        // controllo se il codice corrisponde ad uno esistente
        if (!this.model.esisteCorso(codins)) {
            this.txtRisultato.appendText("Il corso non esiste");
            return;
        }

        Map<String, Integer> statistiche = this.model
                .getDivisioneCDS(new Corso(codins, null, null, null));

        for (String cds : statistiche.keySet()) {
            this.txtRisultato.appendText(cds + " " + statistiche.get(cds) + "\n");
        }
    ...
    void stampaStudenti(ActionEvent event) {
        ...
        List<Studente> studenti = this.model
                .getStudentiByCorso(new Corso(codins, null, null, null));
